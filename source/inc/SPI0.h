...
#define	mskSSP_CPHA_FALLING_EDGE 	(SSP_CPHA_FALLING_EDGE)
#define	mskSSP_CPHA_RISING_EDGE		(SSP_CPHA_RISING_EDGE)


/* SSP n Clock Divider register <SSPn_CLKDIV> (0x08) */
																		//[7:0]SSPn clock divider
#define	SSP_DIV  								48		//MCLK/n, n = 2, 4, 6, 8, ...,512
...
#define	__SPI0_OUTPUTMODE_SEL0 	 SN_GPIO1->MODE |= 0x04;	//set P12 is ouput mode
#define	__SPI0_SET_SEL0			 SN_GPIO1->BSET |= 0x04;
#define	__SPI0_CLR_SEL0			 SN_GPIO1->BCLR |= 0x04;

#define	__SPI0_SET_SEL1			 SN_GPIO1->BSET |= 0x02;
#define	__SPI0_CLR_SEL1			 SN_GPIO1->BCLR |= 0x02;
...
void SSP0_InterruptDisEnable(void);
