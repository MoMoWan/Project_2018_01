...
Abstract:
  This file contains the USB HID (Human Interface Device) definitions.
...
#define HID_SUBCLASS_NONE                       0x00      // HID Subclass Codes
#define HID_SUBCLASS_BOOT                       0x01      

#define USB_INTERFACE_0                         0x00      // HID Interface number
#define USB_INTERFACE_1                         0x01      
#define USB_INTERFACE_2                         0x02      

#define HID_PROTOCOL_NONE                       0x00      // HID Protocol Codes
#define HID_PROTOCOL_KEYBOARD                   0x01      
#define HID_PROTOCOL_MOUSE                      0x02      

#define HID_HID_DESCRIPTOR_TYPE                 0x21      // HID Descriptor Types
#define HID_REPORT_DESCRIPTOR_TYPE              0x22
#define HID_PHYSICAL_DESCRIPTOR_TYPE            0x23

typedef __packed struct _HID_DESCRIPTOR {                 // HID Descriptor
  U8  bLength;
  U8  bDescriptorType;
  U16 bcdHID;
  U8  bCountryCode;
  U8  bNumDescriptors;
  __packed struct _HID_DESCRIPTOR_LIST {                  // Array of one or more descriptors
    U8  bDescriptorType;
    U16 wDescriptorLength;
  } DescriptorList[1];
} HID_DESCRIPTOR;

#define HID_REQUEST_GET_REPORT                  0x01      // HID Request Codes
...
#define HID_REPORT_INPUT                        0x01      // HID Report Types
#define HID_REPORT_OUTPUT                       0x02
#define HID_REPORT_FEATURE                      0x03

#define HID_USAGE_PAGE_UNDEFINED                0x00      // Usage Pages
...
#define HID_USAGE_GENERIC_POINTER               0x01      // Generic Desktop Page (0x01)
...
#define HID_USAGE_SIMULATION_RUDDER             0xBA      // Simulation Controls Page (0x02)
#define HID_USAGE_SIMULATION_THROTTLE           0xBB

#define HID_USAGE_KEYBOARD_NOEVENT              0x00      // Keyboard/Keypad Page (0x07)
#define HID_USAGE_KEYBOARD_ROLLOVER             0x01      // Error "keys"
#define HID_USAGE_KEYBOARD_POSTFAIL             0x02
#define HID_USAGE_KEYBOARD_UNDEFINED            0x03
#define HID_USAGE_KEYBOARD_aA                   0x04      // Letters
#define HID_USAGE_KEYBOARD_zZ                   0x1D
#define HID_USAGE_KEYBOARD_ONE                  0x1E      // Numbers
...
#define HID_USAGE_KEYBOARD_F1                   0x3A      // Funtion keys
#define HID_USAGE_KEYBOARD_F12                  0x45
#define HID_USAGE_KEYBOARD_PRINT_SCREEN         0x46
#define HID_USAGE_KEYBOARD_LCTRL                0xE0      // Modifier Keys
...
#define HID_USAGE_LED_NUM_LOCK                  0x01      // LED Page (0x08)
...
#define HID_USAGE_TELEPHONY_PHONE               0x01      // Telephony Device Page (0x0B)
...
#define HID_USAGE_CONSUMER_CONTROL              0x01      // Consumer Page (0x0C)

#define HID_Input(x)                            0x81, x   // HID Report Item Macros
#define HID_Output(x)                           0x91, x
#define HID_Feature(x)                          0xB1, x
#define HID_Collection(x)                       0xA1, x
#define HID_EndCollection                       0xC0

#define HID_Data                                0 << 0    // Data (Input, Output, Feature)
...
#define HID_Physical                            0x00      // Collection Data
...
#define HID_UsagePage(x)                        0x05, x   // Global Items
...
#define HID_Usage(x)                            0x09, x   // Local Items
