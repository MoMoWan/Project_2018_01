...
#define	UTILITY_10US_DELAY		60>>SN_SYS0->AHBCP
...
/*****************************************************************************
* Function		: UT_MAIN_DelayNx5us
* Description	: Delay 5 us @ Fcpu = 48MHz
* Input			: N
* Output		: None
* Return		: None
* Note			: May have some deviation (+/-20%)
...
{
	N*=UTILITY_10US_DELAY;			//10us @ Fcpu = 48MHz
	N=N>>1;							//Div 2 ==> N=5us @ Fcpu = 48MHz							
    while (N--);
}

/*****************************************************************************
* Function		: UT_MAIN_DelayNx1us
* Description	: Delay 1 us @ Fcpu = 48MHz
* Input			: N
* Output		: None
* Return		: None
* Note			: May have some deviation (+/-20%)
