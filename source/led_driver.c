...
const COLOR cnstMXXcolor[8] = {
  {0xFF, 0xFF, 0xFF}, // Color 1  White 
  {0xFF, 0x00, 0x00}, // Color 2  Red
  {0xFF, 0x30, 0x00}, // Color 3  Orange
  {0xFF, 0xFF, 0x00}, // Color 4  Yellow
  {0x00, 0xFF, 0x00}, // Color 4  Green
  {0x00, 0xFF, 0xFF}, // Color 6  Cyan
  {0x00, 0x00, 0xFF},  // Color 7  Orange   
  {0xFF, 0x00, 0xFF}, // Color 5  Purple
};
const COLOR colorTable[52] = {
  {255,   255,   255  }, // 1th R
  {0,   255,    255 }, // 2th
  {0,   0,   255 }, // 3th
  {0,   255,    0 }, // 6th
